 ...
 */
package de.langmi.spring.batch.examples.complex.crosscutting.interstepcommunication.databean;
...
/**
 * Tasklet which accesses a (Spring) Bean read a value.
 *
 ...
 */
public class ReadingDataBeanTasklet implements Tasklet {

    private static final Logger LOG = LoggerFactory.getLogger(ChangingDataBeanTasklet.class);
    /** Databean. */
    private Map dataMap;
