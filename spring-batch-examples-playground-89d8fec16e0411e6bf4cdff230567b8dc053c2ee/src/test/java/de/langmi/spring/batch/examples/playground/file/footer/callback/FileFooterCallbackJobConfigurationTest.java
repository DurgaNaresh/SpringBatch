...
import de.langmi.spring.batch.examples.playground.*;
...
@ContextConfiguration(locations = {
    "classpath*:spring/batch/job/file-footer-callback-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class FileFooterCallbackJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file", new JobParameter("file:target/test-outputs/file/footer-callback/output.txt"));
