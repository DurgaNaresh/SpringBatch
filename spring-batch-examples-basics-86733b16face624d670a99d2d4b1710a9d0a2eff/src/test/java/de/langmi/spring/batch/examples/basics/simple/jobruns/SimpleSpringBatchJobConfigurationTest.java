 ...
 */
package de.langmi.spring.batch.examples.basics.simple.jobruns;
...
@ContextConfiguration(
        locations = {"classpath*:spring/batch/job/simple/simple-spring-batch-job.xml",
                       "classpath*:spring/batch/setup/test/*"})
@RunWith(SpringJUnit4ClassRunner.class)
public class SimpleSpringBatchJobConfigurationTest {
