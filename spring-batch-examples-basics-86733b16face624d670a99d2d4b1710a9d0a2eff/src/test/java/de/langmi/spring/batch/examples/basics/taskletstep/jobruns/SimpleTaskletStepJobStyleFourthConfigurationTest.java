...
@ContextConfiguration(locations = {
    "classpath*:spring/batch/job/tasklet/config-styles/simple-taskletstep-job-config-style-4.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class SimpleTaskletStepJobStyleFourthConfigurationTest {
