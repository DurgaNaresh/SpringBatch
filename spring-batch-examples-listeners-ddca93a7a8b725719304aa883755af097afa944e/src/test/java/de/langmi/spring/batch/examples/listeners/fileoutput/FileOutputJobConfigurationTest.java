...
import de.langmi.spring.batch.examples.listeners.*;
...
@ContextConfiguration(locations = {
    "classpath*:spring/batch/job/listeners/listener-with-file-output-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class FileOutputJobConfigurationTest {
