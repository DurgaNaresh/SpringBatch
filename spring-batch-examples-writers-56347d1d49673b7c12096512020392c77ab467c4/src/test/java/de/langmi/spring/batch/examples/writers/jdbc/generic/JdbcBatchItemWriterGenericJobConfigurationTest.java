...
@ContextConfiguration({
    "classpath*:spring/batch/job/writers/jdbc/jdbc-batch-item-writer-generic-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class JdbcBatchItemWriterGenericJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        for (StepExecution step : jobExecution.getStepExecutions()) {
            ...
            assertEquals("Write Count mismatch, changed input?",
                         EXPECTED_COUNT, step.getWriteCount());
        }
    }
