 ...
 */
package de.langmi.spring.batch.examples.readers.jdbc.generic;
...
@ContextConfiguration({
    "classpath*:spring/batch/job/readers/jdbc/jdbc-paging-item-reader-generic-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class JdbcPagingItemReaderGenericJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file", new JobParameter("file:target/test-outputs/readers/jdbc/jdbc-paging-item-reader-generic/output.txt"));
