...
/**
 * JobConfigurationTest for composite item reader job with JDBC readers
 * with different datasources each.
 *
 * @author Michael R. Lange <michael.r.lange@langmi.de> 
 */
@ContextConfiguration({
    "classpath*:spring/batch/job/readers/jdbc/jdbc-composite-item-reader-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class JdbcCompositeItemReaderJobConfigurationTest {
    ...
    @Autowired
    @Qualifier("dataSourceReader1")
    private DataSource dataSource1;
    @Autowired
    @Qualifier("dataSourceReader2")
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file", new JobParameter("file:target/test-outputs/readers/jdbc/jdbc-composite-item-reader/output.txt"));
    ...
    public void setUp() throws Exception {
        setupDataSource(dataSource1);
        setupDataSource(dataSource2);
    }

    private void setupDataSource(DataSource dataSource) throws SQLException {
