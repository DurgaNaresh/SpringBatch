...
@ContextConfiguration({
    "classpath*:spring/batch/job/readers/jdbc/jdbc-cursor-item-reader-job.xml",
    "classpath*:spring/batch/setup/**/*.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
public class JdbcCursorItemReaderJobConfigurationTest {
    ...
    public void launchJob() throws Exception {
        ...
        jobParametersMap.put("output.file", new JobParameter("file:target/test-outputs/readers/jdbc/jdbc-cursor-item-reader/output.txt"));
